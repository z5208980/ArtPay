/*
    IMPLEMENTATION BASED ON near_contract_standards::non_fungible_token::metadata
    with the addition of compulsory copyright metadata
*/
...
pub struct TokenMetadata {
    ...
    // Copyright
    pub copyright: Option<String>, // IPFS, URL, string statement
