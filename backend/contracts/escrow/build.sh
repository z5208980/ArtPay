...
# near view $SUBACCOUNT get_escrow_new '{"client": "'$NFTACCOUNT'", "contractor": "'$MASTERACCOUNT'", "id": 0}' --accountId $MASTERACCOUNT

# near call $SUBACCOUNT set_nft_deliverable '{"client": "'$NFTACCOUNT'", "id": 0, "nft_address": "nft.artpay.testnet", "token_id": "'$TOKENNAME'"}' --accountId $MASTERACCOUNT --depositYocto 1 --gas 200000000000000
