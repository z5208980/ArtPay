...
# near call $SUBACCOUNT create_new_escrow '{"contractor": "escrow.artpay.testnet", "nft_address": "escrow.artpay.testnet", "token_id": "1", "timestamp": 1234234}' --accountId $SUBACCOUNT
